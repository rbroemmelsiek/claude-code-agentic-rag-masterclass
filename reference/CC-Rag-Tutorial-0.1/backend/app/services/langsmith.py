...
def get_traced_openai_client() -> OpenAI:
    ...
    The wrap_openai wrapper automatically traces all API calls including
    the Responses API (chat completions, responses, etc.).
    """
...
def get_traced_async_openai_client() -> AsyncOpenAI:
    ...
    Enables tracing for async streaming operations.
    """
